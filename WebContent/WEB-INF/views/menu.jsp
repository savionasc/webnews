...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li class="active"><a href="login"><fmt:message
	...
	<div class="container">
		<c:if test="${noticias.size() > 0}">
		<h2>
			<fmt:message key="menu.thumb.titulo" />
		</h2>
		<p>
			<fmt:message key="menu.thumb.subtitulo" />
		</p>
		</c:if>
		<div class="row">
			<c:forEach var="a" items="${noticias}">
				<div class="col-md-4">
					<form action="adicionarFavorito" method="post">
						<input type="hidden" value="${a.noticiaId}" name="noticia" /> <input
							type="hidden" value="${usuario_logado.id}" name="usuario" /> <a
							style="margin-left: 200px;" href="javascript:;"
							onclick="parentNode.submit();"><fmt:message
								key="menu.thumb.addfavorito" /></a>
					</form>
					<a href="listarComentarios?id=${a.noticiaId}" class="thumbnail">
						<p>${a.titulo}</p> <img
						src="<c:url value="/resources/images/${a.noticiaId}.png" />"
	...
	<footer class="rodape">
            <ul class="nav nav-list pull-left">
                <li class="nav-header">
                    <font><font>Idiomas</font></font>
                </li>
                <li>
                    <a href="mudaLingua.jsp?lingua=pt_BR"><font><font>Português Brasil</font></font></a>
                </li>
                <li>
                    <a href="mudaLingua.jsp?lingua=en_US"><font><font>English</font></font></a>
                </li>
                <li>
                    <a href="mudaLingua.jsp?lingua=de_DE"><font><font>Deutsch</font></font></a>
                </li>
            </ul>
            <ul class="nav nav-list pull-left">
                <li class="nav-header">
                ...
                <li>
                    <a href="http://google.com.br" target="_blank"><font><font>Google o nosso parceiro</font></font></a>
                </li>
            </ul>
        </footer>
</body>
